...
GSMUT=function(G,mediator,outcome,covariates=NULL,outcome_type,approxi=TRUE,verbose=FALSE){
  ...
  res=Generalized_Testing_coefficient_of_mediator(G = G, mediator = mediator, outcome = outcome, covariates = covariates,
                                                  outcome_type = outcome_type, approxi = approxi, verbose = verbose)
