SMUT=function(G,mediator,outcome,covariates=NULL,outcome_type="continuous",method="score",
  ...
  p_value_theta=Testing_coefficient_of_mediator(G = G, mediator = mediator, outcome = outcome, covariates = covariates, 
                                                outcome_type = outcome_type, method = method, approxi = approxi, debug = debug)
